...
(function ($) {
    ...
    (function (gb, kportal, $, undefined) {
    	...
    	var items = [], itemsRaw = [], categ = [], categItems = [], itemsSearched = [], prevSearch = '';
    	...
    	$('#search').autocomplete({
    		lookup: ['Invoice Reader Field Learning Documentation', 'eFlow Modules on 64 Bits Memory Usage', 'eFlow 4 and Clustering'],
    	...
    	$('#search').keyup(function (e) {
    		...
    		if (e.keyCode !== 32 && e.keyCode !== 13 && prevSearch !== str) {
    			_k.runSearch();
    			prevSearch = str;
    		}
