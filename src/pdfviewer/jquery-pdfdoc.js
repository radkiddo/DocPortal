...
(function ( $ ){
    $.fn.PDFDoc = function( options ) {
         ...
         */
        //var page_text = $('<span>', { 'class' : 'h-pdf-pagetext', 'html' : 'Page: ' + settings.page } );
        ...
        //progress.css( { top : (canvas_container.height() / 6) - (progress.height() / 6), left : (canvas_container.width() / 9) - (progress.width() / 9) } );
        
        progress.css( { top : 80, left : 260 } );
